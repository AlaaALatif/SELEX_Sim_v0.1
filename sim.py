...
for r in range(roundNum):
    if(r==0):
        ...
        slctdSeqs = S.stochasticHammingSelection(alphabetSet, seqLength, None, aptamerSeqs, selectionThreshold, initialSeqNum, 0, r)
        ...
        slctdSeqs = S.stochasticHammingSelection(alphabetSet, seqLength, amplfdSeqs, None, selectionThreshold, totalSeqNum, uniqSeqNum, r)
