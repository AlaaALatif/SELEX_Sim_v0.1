...
#   It follows the design of trainingSetGenerator.py but takes the logarithm
#   of the final seq counts (see BruteGMMlogged). It also sorts the 
...
if rank == 0:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.1, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.1
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
...
if rank == 1:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.2, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.2
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
            for k, mu in enumerate(modelParams):
...
if rank == 2:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.3, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.3
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
            for k, mu in enumerate(modelParams):
...
if rank == 3:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.4, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.4
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
            for k, mu in enumerate(modelParams):
...
if rank == 4:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.5, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.5
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
            for k, mu in enumerate(modelParams):
...
if rank == 5:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.6, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.6
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
            for k, mu in enumerate(modelParams):
...
if rank == 6:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.7, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.7
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
            for k, mu in enumerate(modelParams):
...
if rank == 7:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.8, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.8
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
            for k, mu in enumerate(modelParams):
...
if rank == 8:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.9, 10000, maxGaussNum)
            data[rank+1][j][2] = 0.9
            data[rank+1][j][0] = i+1
            data[rank+1][j][1] = n+1
            for k, mu in enumerate(modelParams):
...
if rank == 9:
    ...
    for i in range(maxInitialCount):
        for n in range(maxPCRcycles):
            modelParams = amp.BruteGMMlogged(i+1, n+1, 0.95, 10000, maxGaussNum)
